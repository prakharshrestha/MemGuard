...
TESTS = test_basic test_edge_cases test_canary test_calloc test_stats benchmark
...
test_canary: $(SOURCES) $(TEST_DIR)/test_canary.c
	$(CC) $(CFLAGS) $(SOURCES) $(TEST_DIR)/test_canary.c -o $(BUILD_DIR)/$@ $(LDFLAGS)

test_calloc: $(SOURCES) $(TEST_DIR)/test_calloc.c
	$(CC) $(CFLAGS) $(SOURCES) $(TEST_DIR)/test_calloc.c -o $(BUILD_DIR)/$@ $(LDFLAGS)

test_stats: $(SOURCES) $(TEST_DIR)/test_stats.c
	$(CC) $(CFLAGS) $(SOURCES) $(TEST_DIR)/test_stats.c -o $(BUILD_DIR)/$@ $(LDFLAGS)
...
tests: all
	...
	./$(BUILD_DIR)/test_canary
	./$(BUILD_DIR)/test_calloc
